...
;;-------------------------------------------------------------------------------
;; Name: Cindy Zhang
;; Pledge: I pledge my honor that I have abided by the Stevens Institute of Techology.
;;-------------------------------------------------------------------------------
...
(define (set-equal? SA SB)
  (cond [(and (subset? SB SA)(subset? SA SB)) #t]
        [else #f]))
...
(define (remove e S)
  (cond [(not(element? e S)) S]
        [else (sym-diff (list e) S)]))
